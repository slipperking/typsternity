...
export const PROBLEMS: Problem[] = [
  ...
  problem('Global Residue Theorem', 'sum_(k=1)^n limits(op("Res"))_(z = z_k) f(z) + limits(op("Res"))_(z = oo) f(z) = 0', 34),
  ...
  problem('Law of Sines', 'a / sin(A) = b / sin(B) = c / sin(C)', 30),
  problem("Heron's Formula", '[A B C] = sqrt(s(s-a)(s-b)(s-c))', 30),
  problem("Euler Line", 'O, H, G "are collinear" ==> overline(O G) = 1 / 2 overline(H G)', 30),
]
