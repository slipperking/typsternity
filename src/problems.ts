...
export const PROBLEMS: Problem[] = [
  ...
  problem('Cauchy-Hadamard Formula', '1/R = limits(op("lim sup"))_(n -> oo) root(n, abs(a_n))', 30),
  ...
  problem('Lorentz Force Law', 'bold(F) = q (bold(E) + bold(v) times bold(B))', 26),
  problem('Charge Continuity Equation', '(partial rho)/(partial t) + nabla dot bold(J) = 0', 28),
  problem('Poynting Vector', 'bold(S) = 1/mu_0 bold(E) times bold(B)', 28),
